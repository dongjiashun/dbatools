...
//    	
//    	String[] test= txt.split("<br/>");
//    	String message = test[1].replaceAll("告警主机：","");
    	try {
     		List<String> filecontext = FileUtils.readLines(new File("resources/filterphone.txt"), "UTF-8");
