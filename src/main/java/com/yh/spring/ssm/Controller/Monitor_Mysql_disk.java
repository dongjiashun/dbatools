...
public class Monitor_Mysql_disk {
	...
	public static void main(String[] args) throws IOException {
		 ArgumentsAnalysisUtils aas = new ArgumentsAnalysisUtils( "数据库实例监控项目说明书" ) ;
		  aas.add( "功能W介绍 " ) ;
		  aas.add( "1.控所有数据库实例的大小" ) ;
		  aas.add( "前提条件" ) ;
		  ...
		  //价值配置文件
		  Properties properties = ZabbixConfig.build("resources/databasedisk.properties");
